...
Spec's file or commit into `agent-tickets` yourself; the caller (`spec-
loop`, or a person running this skill directly) runs `board-step
report` to enact whichever fate you report:
